...
const Chatbot: React.FC<ChatbotProps> = ({ isEmbedded = false, onClose }) => {
  ...
  const getBackendURL = (): string => {
    ...
    return process.env.BACKEND_URL || "http://127.0.0.1:8000/api";
  };
...
<div
  className="fixed z-[99999] w-[360px] max-w-[90vw]"
  style={{
...
>
  {/* Chatbot container */}
  <div className="bg-gradient-to-br from-blue-50 to-indigo-100 rounded-2xl shadow-2xl border border-gray-300 overflow-hidden transition-all duration-300 flex flex-col h-[65vh] max-h-[75vh]">
    ...
    <div className="flex-1 overflow-y-auto p-4 bg-blue-100 space-y-4">
      ...
      {messages.length === 0 && !selectedText && (
        <div className="text-center py-8">
          <div className="inline-block p-4 bg-blue-200 rounded-lg border border-blue-300 shadow-sm">
