---
id: 1
title: "better-auth-signup-signin-onboarding-spec"
stage: "spec"
date_iso: "2025-12-12"
surface: "agent"
...
user: "user"
command: "/sp.specify"
labels: ["auth", "better-auth", "onboarding", "specification"]
links:
...
- Add new table or extend existing profiles table additively
...
- \`POST /auth/verify-session\`: Verify Better-Auth session token
