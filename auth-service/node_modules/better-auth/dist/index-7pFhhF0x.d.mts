import { St as InferUser, xt as InferSession } from "./index-ItLtiMMN.mjs";
...
import * as better_call47 from "better-call";
...
declare const customSession: <Returns extends Record<string, any>, O extends BetterAuthOptions = BetterAuthOptions>(fn: (session: {
  ...
  hooks: {
    after: {
      ...
      handler: (inputContext: better_call47.MiddlewareInputContext<better_call47.MiddlewareOptions>) => Promise<Awaited<Returns>[] | undefined>;
    }[];
  };
  endpoints: {
    getSession: better_call47.StrictEndpoint<"/get-session", {
      method: "GET";
