import { Tt as User } from "./index-ItLtiMMN.mjs";
...
import * as _better_fetch_fetch120 from "@better-fetch/fetch";
...
declare const backupCode2fa: (opts: BackupCodeOptions) => {
  ...
  endpoints: {
     ...
     */
    verifyBackupCode: better_call734.StrictEndpoint<"/two-factor/verify-backup-code", {
      method: "POST";
      body: z.ZodObject<{
        code: z.ZodString;
     ...
     */
    generateBackupCodes: better_call734.StrictEndpoint<"/two-factor/generate-backup-codes", {
      method: "POST";
      body: z.ZodObject<{
        password: z.ZodString;
      }, z.core.$strip>;
      use: ((inputContext: better_call734.MiddlewareInputContext<better_call734.MiddlewareOptions>) => Promise<{
        session: {
     ...
     */
    viewBackupCodes: better_call734.StrictEndpoint<"/two-factor/view-backup-codes", {
      method: "POST";
      body: z.ZodObject<{
...
declare const otp2fa: (options?: OTPOptions | undefined) => {
  ...
  endpoints: {
     ...
     */
    sendTwoFactorOTP: better_call734.StrictEndpoint<"/two-factor/send-otp", {
      method: "POST";
     ...
     */
    verifyTwoFactorOTP: better_call734.StrictEndpoint<"/two-factor/verify-otp", {
      method: "POST";
      body: z.ZodObject<{
        code: z.ZodString;
        trustDevice: z.ZodOptional<z.ZodBoolean>;
...
declare const totp2fa: (options?: TOTPOptions | undefined) => {
  ...
  endpoints: {
     ...
     */
    generateTOTP: better_call734.StrictEndpoint<"/totp/generate", {
      method: "POST";
      body: z.ZodObject<{
        secret: z.ZodString;
      }, z.core.$strip>;
     ...
     */
    getTOTPURI: better_call734.StrictEndpoint<"/two-factor/get-totp-uri", {
      method: "POST";
      use: ((inputContext: better_call734.MiddlewareInputContext<better_call734.MiddlewareOptions>) => Promise<{
        session: {
          session: Record<string, any> & {
     ...
     */
    verifyTOTP: better_call734.StrictEndpoint<"/two-factor/verify-totp", {
      method: "POST";
      body: z.ZodObject<{
        code: z.ZodString;
        trustDevice: z.ZodOptional<z.ZodBoolean>;
...
declare const twoFactorClient: (options?: {
  ...
  fetchPlugins: {
    ...
    name: string;
    hooks: {
      onSuccess(context: _better_fetch_fetch120.SuccessContext<any>): Promise<void>;
    };
  }[];
};
//#endregion
...
declare const twoFactor: (options?: TwoFactorOptions | undefined) => {
  ...
  endpoints: {
     ...
     */
    enableTwoFactor: better_call734.StrictEndpoint<"/two-factor/enable", {
      method: "POST";
      body: z.ZodObject<{
        password: z.ZodString;
     ...
     */
    disableTwoFactor: better_call734.StrictEndpoint<"/two-factor/disable", {
      method: "POST";
      body: z.ZodObject<{
        password: z.ZodString;
      }, z.core.$strip>;
  ...
  hooks: {
    after: {
      ...
      handler: (inputContext: better_call734.MiddlewareInputContext<better_call734.MiddlewareOptions>) => Promise<{
