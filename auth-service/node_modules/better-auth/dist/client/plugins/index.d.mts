import { Sn as InferAdditionalFieldsFromPluginOptions, dt as BetterAuthOptions$1, en as SessionQueryParams } from "../../index-ItLtiMMN.mjs";
...
import { F as OrganizationOptions, S as Team, _t as admin, at as OAuthAccessToken, b as OrganizationRole, bt as SessionWithImpersonatedBy, c as InferMember, ct as TokenBody, f as InferTeam, g as Member, gt as ApiKeyOptions, ht as ApiKey, it as CodeVerificationValue, l as InferOrganization, nt as AuthorizationQuery, ot as OIDCMetadata, p as Invitation, pt as apiKey, r as OrganizationPlugin, rt as Client, s as InferInvitation, st as OIDCOptions, tt as oidcProvider, v as Organization, vt as AdminOptions, w as TeamMember, xt as UserWithRole, yt as InferAdminRolesFromOption } from "../../index-V081dNa-.mjs";
import { i as schema, n as AnonymousOptions, r as UserWithAnonymous, t as anonymous } from "../../index-veGVCQDP.mjs";
import "../../index-BgRi_ahI.mjs";
import "../../index-fnLzWr2C.mjs";
import "../../index-7pFhhF0x.mjs";
import { n as deviceAuthorization } from "../../index-CoRq_As_.mjs";
import { t as emailOTP } from "../../index-D8JLGqFA.mjs";
import { _ as GenericOAuthConfig, a as OktaOptions, c as microsoftEntraId, d as KeycloakOptions, f as keycloak, g as auth0, h as Auth0Options, i as slack, l as LineOptions, m as hubspot, n as genericOAuth, o as okta, p as HubSpotOptions, r as SlackOptions, s as MicrosoftEntraIdOptions, t as BaseOAuthProviderOptions, u as line, v as GenericOAuthOptions } from "../../index-P-wYkAD5.mjs";
import "../../index-1pOfmpZV.mjs";
import { c as Jwk, l as JwtOptions, o as JWKOptions, s as JWSAlgorithms, t as jwt } from "../../index-BfGjzoFj.mjs";
import { n as magicLink } from "../../index-ZA57__3E.mjs";
import { n as multiSession, t as MultiSessionConfig } from "../../index-C-MbAsf4.mjs";
import "../../index-HVSLuFvF.mjs";
import "../../index-BgCLcoV7.mjs";
import { n as oneTimeToken, t as OneTimeTokenOptions } from "../../index-CVZJwI8R.mjs";
import "../../index-MexUZ7RH.mjs";
import { n as PhoneNumberOptions, r as UserWithPhoneNumber, t as phoneNumber } from "../../index-BDCxDMd9.mjs";
import { n as siwe } from "../../index-BP8GKS1P.mjs";
import { a as TwoFactorProvider, c as TOTPOptions, d as otp2fa, f as BackupCodeOptions, g as verifyBackupCode, h as getBackupCodes, i as TwoFactorOptions, l as totp2fa, m as generateBackupCodes, n as twoFactorClient, o as TwoFactorTable, p as backupCode2fa, s as UserWithTwoFactor, u as OTPOptions } from "../../index-GPso9wJG.mjs";
import { n as username } from "../../index-Bzvy2fZc.mjs";
...
import * as _better_fetch_fetch110 from "@better-fetch/fetch";
...
declare const jwtClient: (options?: JwtClientOptions) => {
  ...
  getActions: ($fetch: _better_fetch_fetch110.BetterFetch) => {
...
declare const oneTapClient: (options: GoogleOneTapOptions) => {
  ...
  fetchPlugins: {
    ...
    name: string;
    hooks: {
      onResponse(ctx: _better_fetch_fetch110.ResponseContext): Promise<void>;
    };
  }[];
  getActions: ($fetch: _better_fetch_fetch110.BetterFetch, _: _better_auth_core25.ClientStore) => {
    oneTap: (opts?: GoogleOneTapActionOptions | undefined, fetchOptions?: ClientFetchOption | undefined) => Promise<void>;
  };
  getAtoms($fetch: _better_fetch_fetch110.BetterFetch): {};
};
//#endregion
...
declare const organizationClient: <CO extends OrganizationClientOptions>(options?: CO | undefined) => {
  ...
  getActions: ($fetch: _better_fetch_fetch110.BetterFetch, _$store: _better_auth_core25.ClientStore, co: _better_auth_core25.BetterAuthClientOptions | undefined) => {
    $Infer: {
  ...
  getAtoms: ($fetch: _better_fetch_fetch110.BetterFetch) => {
    ...
    activeOrganization: nanostores6.PreinitializedWritableAtom<{
      ...
      error: null | _better_fetch_fetch110.BetterFetchError;
      isPending: boolean;
...
//#endregion
export { AdminOptions, AnonymousOptions, ApiKey, ApiKeyClientPlugin, ApiKeyOptions, Auth0Options, AuthorizationQuery, Awaitable, BackupCodeOptions, type BaseOAuthProviderOptions, Client, CodeVerificationValue, DeepPartial, Expand, type GenericOAuthConfig, type GenericOAuthOptions, GoogleOneTapActionOptions, GoogleOneTapOptions, HasRequiredKeys, HubSpotOptions, InferAdminRolesFromOption, InferServerPlugin, JWKOptions, JWSAlgorithms, Jwk, JwtOptions, KeycloakOptions, LastLoginMethodClientConfig, LineOptions, LiteralNumber, LiteralString, LiteralUnion, MicrosoftEntraIdOptions, type MultiSessionConfig, OAuthAccessToken, OIDCMetadata, OIDCOptions, OTPOptions, OidcClientPlugin, OktaOptions, OmitId, type OneTimeTokenOptions, PhoneNumberOptions, PreserveJSDoc, Prettify, PrettifyDeep, Primitive, RequiredKeysOf, SessionWithImpersonatedBy, SlackOptions, StripEmptyObjects, TOTPOptions, TokenBody, TwoFactorOptions, TwoFactorProvider, TwoFactorTable, UnionToIntersection, UserWithAnonymous, UserWithPhoneNumber, UserWithRole, UserWithTwoFactor, WithoutEmpty, adminClient, anonymousClient, apiKeyClient, auth0, backupCode2fa, clientSideHasPermission, customSessionClient, deviceAuthorizationClient, emailOTPClient, generateBackupCodes, genericOAuthClient, getBackupCodes, hubspot, inferAdditionalFields, inferOrgAdditionalFields, jwtClient, keycloak, lastLoginMethodClient, line, magicLinkClient, microsoftEntraId, multiSessionClient, oidcClient, okta, oneTapClient, oneTimeTokenClient, organizationClient, otp2fa, phoneNumberClient, schema, siweClient, slack, totp2fa, twoFactorClient, usernameClient, verifyBackupCode };