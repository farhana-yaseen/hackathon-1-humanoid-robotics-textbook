...
declare function createAuthClient<Option extends BetterAuthClientOptions$1>(options?: Option | undefined): UnionToIntersection<InferResolvedHooks<Option>> & InferClientAPI<Option> & InferActions<Option> & {
  ...
  $fetch: _better_fetch_fetch94.BetterFetch<{
    plugins: (_better_fetch_fetch94.BetterFetchPlugin | {
      id: string;
      name: string;
      hooks: {
        onSuccess(context: _better_fetch_fetch94.SuccessContext<any>): void;
      };
    } | {
      id: string;
      name: string;
      hooks: {
        onSuccess: ((context: _better_fetch_fetch94.SuccessContext<any>) => Promise<void> | void) | undefined;
        onError: ((context: _better_fetch_fetch94.ErrorContext) => Promise<void> | void) | undefined;
        onRequest: (<T extends Record<string, any>>(context: _better_fetch_fetch94.RequestContext<T>) => Promise<_better_fetch_fetch94.RequestContext | void> | _better_fetch_fetch94.RequestContext | void) | undefined;
        onResponse: ((context: _better_fetch_fetch94.ResponseContext) => Promise<Response | void | _better_fetch_fetch94.ResponseContext> | Response | _better_fetch_fetch94.ResponseContext | void) | undefined;
      };
    })[];
    ...
    onRetry?: ((response: _better_fetch_fetch94.ResponseContext) => Promise<void> | void) | undefined;
    hookOptions?: {
      cloneResponse?: boolean;
    } | undefined;
    timeout?: number | undefined;
    customFetchImpl: _better_fetch_fetch94.FetchEsque;
    baseURL: string;
    ...
    retry?: _better_fetch_fetch94.RetryOptions | undefined;
    retryAttempt?: number | undefined;
    output?: (_better_fetch_fetch94.StandardSchemaV1 | typeof Blob | typeof File) | undefined;
    errorSchema?: _better_fetch_fetch94.StandardSchemaV1 | undefined;
