import { Tt as User, wt as Session } from "./index-ItLtiMMN.mjs";
import { GenericEndpointContext } from "@better-auth/core";
import * as z from "zod";
import * as better_call91 from "better-call";
...
declare const oneTimeToken: (options?: OneTimeTokenOptions | undefined) => {
  ...
  endpoints: {
     ...
     */
    generateOneTimeToken: better_call91.StrictEndpoint<"/one-time-token/generate", {
      method: "GET";
      use: ((inputContext: better_call91.MiddlewareInputContext<better_call91.MiddlewareOptions>) => Promise<{
        session: {
     ...
     */
    verifyOneTimeToken: better_call91.StrictEndpoint<"/one-time-token/verify", {
      method: "POST";
      body: z.ZodObject<{
        token: z.ZodString;
      }, z.core.$strip>;
