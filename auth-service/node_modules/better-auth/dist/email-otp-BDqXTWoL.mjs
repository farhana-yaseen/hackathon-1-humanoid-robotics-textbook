...
import { c as setSessionCookie, s as setCookieCache } from "./cookies-DmQmKltR.mjs";
...
const createVerificationOTP = (opts) => createAuthEndpoint("/email-otp/create-verification-otp", {
	method: "POST",
...
*/
const getVerificationOTP = (opts) => createAuthEndpoint("/email-otp/get-verification-otp", {
	method: "GET",
