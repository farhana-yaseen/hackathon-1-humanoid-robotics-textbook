...
declare const genericOAuth: (options: GenericOAuthOptions) => {
  ...
  endpoints: {
    signInWithOAuth2: better_call27.StrictEndpoint<"/sign-in/oauth2", {
      method: "POST";
    ...
    oAuth2Callback: better_call27.StrictEndpoint<"/oauth2/callback/:providerId", {
      method: "GET";
    ...
    oAuth2LinkAccount: better_call27.StrictEndpoint<"/oauth2/link", {
      method: "POST";
      body: zod24.ZodObject<{
        providerId: zod24.ZodString;
      ...
      use: ((inputContext: better_call27.MiddlewareInputContext<better_call27.MiddlewareOptions>) => Promise<{
        session: {
