...
import * as better_call57 from "better-call";
...
declare const phoneNumber: (options?: PhoneNumberOptions | undefined) => {
  ...
  hooks: {
    before: {
      matcher: (ctx: _better_auth_core9.HookEndpointContext) => boolean;
      handler: (inputContext: better_call57.MiddlewareInputContext<better_call57.MiddlewareOptions>) => Promise<never>;
    }[];
  };
  endpoints: {
    signInPhoneNumber: better_call57.StrictEndpoint<"/sign-in/phone-number", {
      method: "POST";
    ...
    sendPhoneNumberOTP: better_call57.StrictEndpoint<"/phone-number/send-otp", {
      method: "POST";
      body: zod60.ZodObject<{
        phoneNumber: zod60.ZodString;
      }, zod_v4_core10.$strip>;
    ...
    verifyPhoneNumber: better_call57.StrictEndpoint<"/phone-number/verify", {
      method: "POST";
      body: zod60.ZodObject<{
        phoneNumber: zod60.ZodString;
    ...
    requestPasswordResetPhoneNumber: better_call57.StrictEndpoint<"/phone-number/request-password-reset", {
      method: "POST";
      body: zod60.ZodObject<{
        phoneNumber: zod60.ZodString;
      }, zod_v4_core10.$strip>;
    ...
    resetPasswordPhoneNumber: better_call57.StrictEndpoint<"/phone-number/reset-password", {
      method: "POST";
      body: zod60.ZodObject<{
        otp: zod60.ZodString;
        phoneNumber: zod60.ZodString;
