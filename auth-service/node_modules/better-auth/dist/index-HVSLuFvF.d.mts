...
declare const oAuthProxy: (opts?: OAuthProxyOptions | undefined) => {
  ...
  endpoints: {
    oAuthProxy: better_call50.StrictEndpoint<"/oauth-proxy-callback", {
      method: "GET";
      operationId: string;
      query: z.ZodObject<{
      ...
      use: ((inputContext: better_call50.MiddlewareInputContext<better_call50.MiddlewareOptions>) => Promise<void>)[];
      metadata: {
        openapi: {
          operationId: string;
          description: string;
  ...
  hooks: {
    before: {
      ...
      handler: (inputContext: better_call50.MiddlewareInputContext<better_call50.MiddlewareOptions>) => Promise<void>;
    }[];
    after: {
      matcher(context: _better_auth_core7.HookEndpointContext): boolean;
      handler: (inputContext: better_call50.MiddlewareInputContext<better_call50.MiddlewareOptions>) => Promise<void>;
