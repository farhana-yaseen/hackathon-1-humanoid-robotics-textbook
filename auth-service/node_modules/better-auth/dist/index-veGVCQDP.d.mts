...
import * as better_call88 from "better-call";
...
declare const anonymous: (options?: AnonymousOptions | undefined) => {
  id: "anonymous";
  endpoints: {
    signInAnonymous: better_call88.StrictEndpoint<"/sign-in/anonymous", {
      method: "POST";
      metadata: {
        openapi: {
          description: string;
  ...
  hooks: {
    after: {
      matcher(ctx: _better_auth_core15.HookEndpointContext): boolean;
      handler: (inputContext: better_call88.MiddlewareInputContext<better_call88.MiddlewareOptions>) => Promise<void>;
    }[];
  };
  schema: {
    user: {
