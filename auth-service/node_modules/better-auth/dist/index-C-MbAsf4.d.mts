...
import * as better_call18 from "better-call";
...
declare const multiSession: (options?: MultiSessionConfig | undefined) => {
  ...
  endpoints: {
     ...
     */
    listDeviceSessions: better_call18.StrictEndpoint<"/multi-session/list-device-sessions", {
      method: "GET";
      requireHeaders: true;
    } & {
      use: any[];
    }, {
      session: _better_auth_core_db0.Session;
     ...
     */
    setActiveSession: better_call18.StrictEndpoint<"/multi-session/set-active", {
      method: "POST";
      body: z.ZodObject<{
        sessionToken: z.ZodString;
      }, z.core.$strip>;
      requireHeaders: true;
      use: ((inputContext: better_call18.MiddlewareInputContext<better_call18.MiddlewareOptions>) => Promise<{
        session: {
      ...
      session: _better_auth_core_db0.Session & Record<string, any>;
      user: _better_auth_core_db0.User & Record<string, any>;
    }>;
    /**
     * ### Endpoint
     *
     ...
     */
    revokeDeviceSession: better_call18.StrictEndpoint<"/multi-session/revoke", {
      method: "POST";
      body: z.ZodObject<{
        sessionToken: z.ZodString;
      }, z.core.$strip>;
  ...
  hooks: {
    after: {
      ...
      handler: (inputContext: better_call18.MiddlewareInputContext<better_call18.MiddlewareOptions>) => Promise<void>;
    }[];
  };
  $ERROR_CODES: {
