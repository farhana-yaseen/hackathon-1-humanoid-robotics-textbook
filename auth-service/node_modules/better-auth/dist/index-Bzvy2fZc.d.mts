...
import * as _better_auth_core_db32 from "@better-auth/core/db";
  ...
  user: {
    fields: {
      username: {
        ...
        returned: true;
        transform: {
          input(value: _better_auth_core_db32.DBPrimitive): string | number | boolean | Date | unknown[] | Record<string, unknown> | null | undefined;
        };
      };
      displayUsername: {
        type: "string";
...
declare const username: (options?: UsernameOptions | undefined) => {
      ...
      databaseHooks: {
        user: {
          create: {
            ...
            } & Record<string, unknown>, context: _better_auth_core11.GenericEndpointContext | undefined): Promise<{
              data: {
  ...
  endpoints: {
    signInUsername: better_call84.StrictEndpoint<"/sign-in/username", {
      method: "POST";
      body: z.ZodObject<{
    ...
    isUsernameAvailable: better_call84.StrictEndpoint<"/is-username-available", {
      method: "POST";
      body: z.ZodObject<{
        username: z.ZodString;
      }, z.core.$strip>;
...
//#endregion
export { username as n, USERNAME_ERROR_CODES as r, UsernameOptions as t };