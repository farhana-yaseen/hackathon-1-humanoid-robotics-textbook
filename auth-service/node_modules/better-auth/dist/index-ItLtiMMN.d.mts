...
declare const createFieldAttribute: <T$1 extends DBFieldType, C$1 extends DBFieldAttributeConfig>(type: T$1, config?: C$1 | undefined) => {
  ...
  defaultValue?: (_better_auth_core_db21.DBPrimitive | (() => _better_auth_core_db21.DBPrimitive)) | undefined;
  onUpdate?: (() => _better_auth_core_db21.DBPrimitive) | undefined;
  transform?: {
    input?: (value: _better_auth_core_db21.DBPrimitive) => _better_auth_core_db21.DBPrimitive | Promise<_better_auth_core_db21.DBPrimitive>;
    output?: (value: _better_auth_core_db21.DBPrimitive) => _better_auth_core_db21.DBPrimitive | Promise<_better_auth_core_db21.DBPrimitive>;
  } | undefined;
  references?: {
    model: string;
    field: string;
 ...
 * trustedOrigins.
 */
declare const originCheckMiddleware: (inputContext: better_call741.MiddlewareInputContext<better_call741.MiddlewareOptions>) => Promise<void>;
declare const originCheck: (getValue: (ctx: GenericEndpointContext) => string | string[]) => (inputContext: better_call741.MiddlewareInputContext<better_call741.MiddlewareOptions>) => Promise<void>;
//#endregion
//#region src/api/routes/account.d.ts
declare const listUserAccounts: better_call741.StrictEndpoint<"/list-accounts", {
  method: "GET";
...
declare const linkSocialAccount: better_call741.StrictEndpoint<"/link-social", {
  method: "POST";
  requireHeaders: true;
  body: z.ZodObject<{
...
declare const unlinkAccount: better_call741.StrictEndpoint<"/unlink-account", {
  method: "POST";
  body: z.ZodObject<{
...
declare const getAccessToken: better_call741.StrictEndpoint<"/get-access-token", {
  method: "POST";
  body: z.ZodObject<{
    providerId: z.ZodString;
    accountId: z.ZodOptional<z.ZodString>;
...
declare const refreshToken: better_call741.StrictEndpoint<"/refresh-token", {
  method: "POST";
  body: z.ZodObject<{
    providerId: z.ZodString;
    accountId: z.ZodOptional<z.ZodString>;
...
declare const accountInfo: better_call741.StrictEndpoint<"/account-info", {
  method: "GET";
  use: ((inputContext: better_call741.MiddlewareInputContext<better_call741.MiddlewareOptions>) => Promise<{
    session: {
      session: Record<string, any> & {
...
declare const callbackOAuth: better_call741.StrictEndpoint<"/callback/:id", {
  method: ("GET" | "POST")[];
  operationId: string;
...
declare const sendVerificationEmail: better_call741.StrictEndpoint<"/send-verification-email", {
  method: "POST";
  operationId: string;
  body: z.ZodObject<{
    email: z.ZodEmail;
...
declare const verifyEmail: better_call741.StrictEndpoint<"/verify-email", {
  method: "GET";
  operationId: string;
  query: z.ZodObject<{
    token: z.ZodString;
  ...
  use: ((inputContext: better_call741.MiddlewareInputContext<better_call741.MiddlewareOptions>) => Promise<void>)[];
  metadata: {
    openapi: {
      description: string;
      parameters: ({
...
declare const error: better_call741.StrictEndpoint<"/error", {
  method: "GET";
  metadata: {
    openapi: {
      description: string;
...
declare const ok: better_call741.StrictEndpoint<"/ok", {
  method: "GET";
  metadata: {
    openapi: {
      description: string;
...
declare const requestPasswordReset: better_call741.StrictEndpoint<"/request-password-reset", {
  method: "POST";
  body: z.ZodObject<{
    email: z.ZodEmail;
...
declare const requestPasswordResetCallback: better_call741.StrictEndpoint<"/reset-password/:token", {
  method: "GET";
  operationId: string;
  query: z.ZodObject<{
...
declare const resetPassword: better_call741.StrictEndpoint<"/reset-password", {
  method: "POST";
  operationId: string;
  query: z.ZodOptional<z.ZodObject<{
...
declare const signInSocial: <O extends BetterAuthOptions>() => better_call741.StrictEndpoint<"/sign-in/social", {
  method: "POST";
  operationId: string;
  body: z.ZodObject<{
    callbackURL: z.ZodOptional<z.ZodString>;
...
declare const signInEmail: <O extends BetterAuthOptions>() => better_call741.StrictEndpoint<"/sign-in/email", {
  method: "POST";
  operationId: string;
  body: z.ZodObject<{
    email: z.ZodString;
...
declare const signOut: better_call741.StrictEndpoint<"/sign-out", {
  method: "POST";
  operationId: string;
  requireHeaders: true;
  metadata: {
...
declare const signUpEmail: <O extends BetterAuthOptions>() => better_call741.StrictEndpoint<"/sign-up/email", {
  method: "POST";
  operationId: string;
...
declare const updateUser: <O extends BetterAuthOptions>() => better_call741.StrictEndpoint<"/update-user", {
  method: "POST";
  operationId: string;
  body: z.ZodRecord<z.ZodString, z.ZodAny>;
  use: ((inputContext: better_call741.MiddlewareInputContext<better_call741.MiddlewareOptions>) => Promise<{
...
declare const changePassword: better_call741.StrictEndpoint<"/change-password", {
  method: "POST";
  operationId: string;
  body: z.ZodObject<{
    newPassword: z.ZodString;
...
declare const setPassword: better_call741.StrictEndpoint<"/set-password", {
  method: "POST";
  body: z.ZodObject<{
    newPassword: z.ZodString;
  }, z.core.$strip>;
...
declare const deleteUser: better_call741.StrictEndpoint<"/delete-user", {
  method: "POST";
  use: ((inputContext: better_call741.MiddlewareInputContext<better_call741.MiddlewareOptions>) => Promise<{
    session: {
      session: Record<string, any> & {
...
declare const deleteUserCallback: better_call741.StrictEndpoint<"/delete-user/callback", {
  method: "GET";
  query: z.ZodObject<{
    token: z.ZodString;
    callbackURL: z.ZodOptional<z.ZodString>;
...
declare const changeEmail: better_call741.StrictEndpoint<"/change-email", {
  method: "POST";
  body: z.ZodObject<{
    newEmail: z.ZodEmail;
    callbackURL: z.ZodOptional<z.ZodString>;
...
declare function getEndpoints<Option extends BetterAuthOptions>(ctx: Promise<AuthContext> | AuthContext, options: Option): {
  api: {
    readonly ok: better_call741.StrictEndpoint<"/ok", {
      method: "GET";
      metadata: {
        openapi: {
          description: string;
    ...
    readonly error: better_call741.StrictEndpoint<"/error", {
      method: "GET";
      metadata: {
        openapi: {
          description: string;
    ...
    readonly signInSocial: better_call741.StrictEndpoint<"/sign-in/social", {
      method: "POST";
      operationId: string;
      body: z.ZodObject<{
        callbackURL: z.ZodOptional<z.ZodString>;
    ...
    readonly callbackOAuth: better_call741.StrictEndpoint<"/callback/:id", {
      method: ("GET" | "POST")[];
      operationId: string;
      body: z.ZodOptional<z.ZodObject<{
        code: z.ZodOptional<z.ZodString>;
    ...
    readonly getSession: better_call741.StrictEndpoint<"/get-session", {
      method: "GET";
      operationId: string;
      query: z.ZodOptional<z.ZodObject<{
        disableCookieCache: z.ZodOptional<z.ZodCoercedBoolean<unknown>>;
    ...
    readonly signOut: better_call741.StrictEndpoint<"/sign-out", {
      method: "POST";
      operationId: string;
      requireHeaders: true;
      metadata: {
    ...
    readonly signUpEmail: better_call741.StrictEndpoint<"/sign-up/email", {
      method: "POST";
      operationId: string;
      body: z.ZodRecord<z.ZodString, z.ZodAny>;
      metadata: {
    ...
    readonly signInEmail: better_call741.StrictEndpoint<"/sign-in/email", {
      method: "POST";
      operationId: string;
      body: z.ZodObject<{
        email: z.ZodString;
    ...
    readonly resetPassword: better_call741.StrictEndpoint<"/reset-password", {
      method: "POST";
      operationId: string;
      query: z.ZodOptional<z.ZodObject<{
        token: z.ZodOptional<z.ZodString>;
    ...
    readonly verifyEmail: better_call741.StrictEndpoint<"/verify-email", {
      method: "GET";
      operationId: string;
      query: z.ZodObject<{
        token: z.ZodString;
    ...
    readonly sendVerificationEmail: better_call741.StrictEndpoint<"/send-verification-email", {
      method: "POST";
      operationId: string;
      body: z.ZodObject<{
        email: z.ZodEmail;
    ...
    readonly changeEmail: better_call741.StrictEndpoint<"/change-email", {
      method: "POST";
      body: z.ZodObject<{
        newEmail: z.ZodEmail;
        callbackURL: z.ZodOptional<z.ZodString>;
    ...
    readonly changePassword: better_call741.StrictEndpoint<"/change-password", {
      method: "POST";
      operationId: string;
      body: z.ZodObject<{
        newPassword: z.ZodString;
    ...
    readonly setPassword: better_call741.StrictEndpoint<"/set-password", {
      method: "POST";
      body: z.ZodObject<{
        newPassword: z.ZodString;
      }, zod_v4_core15.$strip>;
    ...
    readonly updateUser: better_call741.StrictEndpoint<"/update-user", {
      method: "POST";
      operationId: string;
      body: z.ZodRecord<z.ZodString, z.ZodAny>;
      use: ((inputContext: better_call741.MiddlewareInputContext<better_call741.MiddlewareOptions>) => Promise<{
    ...
    readonly deleteUser: better_call741.StrictEndpoint<"/delete-user", {
      method: "POST";
      use: ((inputContext: better_call741.MiddlewareInputContext<better_call741.MiddlewareOptions>) => Promise<{
        session: {
          session: Record<string, any> & {
    ...
    readonly requestPasswordReset: better_call741.StrictEndpoint<"/request-password-reset", {
      method: "POST";
      body: z.ZodObject<{
        email: z.ZodEmail;
        redirectTo: z.ZodOptional<z.ZodString>;
    ...
    readonly requestPasswordResetCallback: better_call741.StrictEndpoint<"/reset-password/:token", {
      method: "GET";
      operationId: string;
      query: z.ZodObject<{
        callbackURL: z.ZodString;
    ...
    readonly listSessions: better_call741.StrictEndpoint<"/list-sessions", {
      method: "GET";
      operationId: string;
      use: ((inputContext: better_call741.MiddlewareInputContext<better_call741.MiddlewareOptions>) => Promise<{
        session: {
    ...
    readonly revokeSession: better_call741.StrictEndpoint<"/revoke-session", {
      method: "POST";
      body: z.ZodObject<{
        token: z.ZodString;
      }, zod_v4_core15.$strip>;
    ...
    readonly revokeSessions: better_call741.StrictEndpoint<"/revoke-sessions", {
      method: "POST";
      use: ((inputContext: better_call741.MiddlewareInputContext<better_call741.MiddlewareOptions>) => Promise<{
        session: {
          session: Record<string, any> & {
    ...
    readonly revokeOtherSessions: better_call741.StrictEndpoint<"/revoke-other-sessions", {
      method: "POST";
      requireHeaders: true;
      use: ((inputContext: better_call741.MiddlewareInputContext<better_call741.MiddlewareOptions>) => Promise<{
        session: {
    ...
    readonly linkSocialAccount: better_call741.StrictEndpoint<"/link-social", {
      method: "POST";
      requireHeaders: true;
      body: z.ZodObject<{
        callbackURL: z.ZodOptional<z.ZodString>;
    ...
    readonly listUserAccounts: better_call741.StrictEndpoint<"/list-accounts", {
      method: "GET";
      use: ((inputContext: better_call741.MiddlewareInputContext<better_call741.MiddlewareOptions>) => Promise<{
        session: {
          session: Record<string, any> & {
    ...
    readonly deleteUserCallback: better_call741.StrictEndpoint<"/delete-user/callback", {
      method: "GET";
      query: z.ZodObject<{
        token: z.ZodString;
        callbackURL: z.ZodOptional<z.ZodString>;
    ...
    readonly unlinkAccount: better_call741.StrictEndpoint<"/unlink-account", {
      method: "POST";
      body: z.ZodObject<{
        providerId: z.ZodString;
        accountId: z.ZodOptional<z.ZodString>;
    ...
    readonly refreshToken: better_call741.StrictEndpoint<"/refresh-token", {
      method: "POST";
      body: z.ZodObject<{
        providerId: z.ZodString;
        accountId: z.ZodOptional<z.ZodString>;
    ...
    readonly getAccessToken: better_call741.StrictEndpoint<"/get-access-token", {
      method: "POST";
      body: z.ZodObject<{
        providerId: z.ZodString;
        accountId: z.ZodOptional<z.ZodString>;
    ...
    readonly accountInfo: better_call741.StrictEndpoint<"/account-info", {
      method: "GET";
      use: ((inputContext: better_call741.MiddlewareInputContext<better_call741.MiddlewareOptions>) => Promise<{
        session: {
          session: Record<string, any> & {
