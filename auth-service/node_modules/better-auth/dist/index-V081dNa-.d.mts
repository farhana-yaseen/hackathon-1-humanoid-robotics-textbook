import { Sn as InferAdditionalFieldsFromPluginOptions, Tt as User$1, wt as Session$1 } from "./index-ItLtiMMN.mjs";
...
declare const admin: <O extends AdminOptions>(options?: O | undefined) => {
      ...
      databaseHooks: {
        ...
        session: {
          create: {
            ...
            } & Record<string, unknown>, ctx: _better_auth_core23.GenericEndpointContext | undefined): Promise<void>;
          };
        };
      };
    };
  ...
  endpoints: {
    ...
    stopImpersonating: better_call606.StrictEndpoint<"/admin/stop-impersonating", {
      ...
      session: _better_auth_core_db7.Session & Record<string, any>;
      user: _better_auth_core_db7.User & Record<string, any>;
    }>;
  ...
  apikey: {
    fields: {
      ...
      metadata: {
        ...
        input: true;
        transform: {
          input(value: _better_auth_core_db7.DBPrimitive): string;
          output(value: _better_auth_core_db7.DBPrimitive): any;
        };
      };
    };
  };
...
declare const oidcProvider: (options: OIDCOptions) => {
  ...
  readonly options: {
    ...
    generateClientId?: (() => string) | undefined;
    generateClientSecret?: (() => string) | undefined;
    getAdditionalUserInfoClaim?: ((user: _better_auth_core_db7.User & Record<string, any>, scopes: string[], client: Client) => Record<string, any> | Promise<Record<string, any>>) | undefined;
    trustedClients?: Client[] | undefined;
    storeClientSecret: "hashed" | "plain" | "encrypted" | {
      hash: (clientSecret: string) => Promise<string>;
    } | {
...
declare const defaultAc: {
  newRole<K$1 extends "organization" | "member" | "invitation" | "team" | "ac">(statements: Subset<K$1, {
    ...
    authorize<K_1 extends K$1>(request: K_1 extends infer T extends keyof Subset<K$1, {
      readonly organization: readonly ["update", "delete"];
      readonly member: readonly ["create", "update", "delete"];
      readonly invitation: readonly ["create", "cancel"];
      readonly team: readonly ["create", "update", "delete"];
...
declare const createInvitation: <O extends OrganizationOptions>(option: O) => better_call606.StrictEndpoint<"/organization/invite-member", {
  ...
  use: (((inputContext: better_call606.MiddlewareInputContext<better_call606.MiddlewareOptions>) => Promise<{
    ...
    getSession: (context: _better_auth_core23.GenericEndpointContext) => Promise<{
      ...
      user: _better_auth_core_db7.User;
    }>;
