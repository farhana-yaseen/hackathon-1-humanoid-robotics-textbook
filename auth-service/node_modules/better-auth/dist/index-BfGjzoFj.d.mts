import { Tt as User, rt as index_d_exports, wt as Session } from "./index-ItLtiMMN.mjs";
...
declare const jwt: (options?: JwtOptions | undefined) => {
  ...
  endpoints: {
    getJwks: better_call32.StrictEndpoint<string, {
      method: "GET";
      metadata: {
        openapi: {
          operationId: string;
    ...
    getToken: better_call32.StrictEndpoint<"/token", {
      method: "GET";
      requireHeaders: true;
      use: ((inputContext: better_call32.MiddlewareInputContext<better_call32.MiddlewareOptions>) => Promise<{
        session: {
    ...
    signJWT: better_call32.StrictEndpoint<"/sign-jwt", {
      method: "POST";
      metadata: {
        SERVER_ONLY: true;
        $Infer: {
    ...
    verifyJWT: better_call32.StrictEndpoint<"/verify-jwt", {
      method: "POST";
      metadata: {
        SERVER_ONLY: true;
        $Infer: {
